...
id=st.number_input("id khách",0,82516,1030)
Age = st.number_input("Tuổi", 18, 50, 18)
CreditScore = st.number_input("Điểm tín dụng", 0, 656, 400)
Balance = st.number_input("Số dư tài khoản", 0.0, 55478.086689, 30000.0)
